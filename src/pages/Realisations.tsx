  ...
  return (
    <div className="font-montserrat">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="flex items-center justify-center w-12 h-12 md:w-16 md:h-16 bg-bo-orange/20 rounded-full mb-3 md:mb-4 mx-auto">
                  {stat.icon}
                </div>
                <div className="text-2xl md:text-3xl font-bold text-bo-orange mb-2">{stat.number}</div>
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 md:px-10">
          <h2 className="text-3xl md:text-4xl font-bold text-bo-dark text-center mb-12 md:mb-16">
                ...
                <div className="grid lg:grid-cols-2">
                  ...
                  <div className="relative h-64 md:h-96">
                    <div className="grid grid-cols-2 h-full">
                      <div className="relative">
                        ...
                        <Badge className="absolute top-2 md:top-4 left-2 md:left-4 bg-red-100 text-red-800 text-xs">
                          Avant
                        </Badge>
                      </div>
                      <div className="relative">
                        <img src={project.afterImage} alt="" className='w-full h-full object-cover'/>
                        <Badge className="absolute top-2 md:top-4 right-2 md:right-4 bg-green-100 text-green-800 text-xs">
                          Après
                        </Badge>
                      </div>
                    </div>
                  ...
                  <CardContent className="p-6 md:p-8">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 space-y-2 sm:space-y-0">
                      <Badge className="bg-bo-orange/10 text-bo-orange hover:bg-bo-orange/20 text-xs w-fit">
                        {project.type}
                      </Badge>
                    ...
                    <h3 className="text-xl md:text-2xl font-bold text-bo-dark mb-2">{project.title}</h3>
                    
                    <div className="flex items-center text-gray-600 mb-4">
                      <MapPin size={14} className="mr-2 text-bo-orange flex-shrink-0" />
                      <span className="text-sm md:text-base">{project.location}</span>
                    </div>
                    
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4 md:mb-6 text-sm">
                      <div>
                    ...
                    <Button className="bg-bo-orange hover:bg-bo-orange/90 text-white w-full text-sm md:text-base">
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {projects.filter(p => !p.featured).map((project, index) => (
              <Card key={index} className="overflow-hidden hover:shadow-xl transition-all duration-300 group h-full flex flex-col">
                {/* Before/After Images */}
                <div className="relative h-40 md:h-48">
                  <div className="grid grid-cols-2 h-full">
                    <div className="relative">
                      <img src={project.beforeImage} alt="" className='w-full h-full object-cover group-hover:scale-105 transition-transform duration-700'/>
                      <Badge className="absolute top-1 md:top-2 left-1 md:left-2 bg-red-100 text-red-800 text-xs">
                        Avant
                      </Badge>
                    </div>
                    <div className="relative">
                      ...
                      <Badge className="absolute top-1 md:top-2 right-1 md:right-2 bg-green-100 text-green-800 text-xs">
                        Après
                      </Badge>
                    </div>
                  </div>
                ...
                <CardContent className="p-4 md:p-6 flex-grow flex flex-col">
                  ...
                  <h3 className="text-base md:text-lg font-bold text-bo-dark mb-2 group-hover:text-bo-orange transition-colors">
                    {project.title}
                  </h3>
                  
                  <div className="flex items-center text-gray-600 mb-3">
                    <MapPin size={12} className="mr-1 text-bo-orange flex-shrink-0" />
                  ...
                  <Button variant="outline" className="w-full border-bo-orange text-bo-orange hover:bg-bo-orange hover:text-white text-xs md:text-sm mt-auto">
                    Voir le projet
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-20 bg-bo-dark text-white">
